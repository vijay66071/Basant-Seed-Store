            ...
            @if($address)
                <div class="col-md-12">
                    <div class="my-account__address-list">
                        <div class="my-addcout__address-list-item">
            ...
            <div class="row mt-5">
              ...
              <div class="col-md-6">
                <div class="form-floating my-3">
                  ...
                  @error('loacality')<span class="text-danger">{{$message}}</span>@enderror
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-floating my-3">
              ...
              <div class="checkout__totals">
                ...
                <table class="checkout-totals">
                  <tbody>
                    <tr>
                      <th>SUBTOTAL</th>
                      <td class="text-right">Rs. {{\Surfsidemedia\Shoppingcart\Facades\Cart::instance('cart')->subtotal()}}</td>
                    </tr>
                    <tr>
                      <th>SHIPPING</th>
                    ...
                    <tr>
                      <th>VAT</th>
                      <td class="text-right">Rs. {{\Surfsidemedia\Shoppingcart\Facades\Cart::instance('cart')->tax()}}</td>
                    </tr>
                    <tr>
                      <th>TOTAL</th>
                      <td class="text-right">Rs.{{\Surfsidemedia\Shoppingcart\Facades\Cart::instance('cart')->total()}}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
